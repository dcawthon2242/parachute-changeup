...
How the repo is laid out, how to reproduce the parachute numbers, and a catalog
of every script family. The argument itself is in `README.md`; the full
technical handoff is `HANDOFF.md`.
...
parachute-changeup/
  ...
  docs/
    REPO_GUIDE.md           this file: layout, reproduction, catalog
  data/
