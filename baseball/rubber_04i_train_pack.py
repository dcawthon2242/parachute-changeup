...
After you tag it, rerun:
    ...
    .venv-cv/bin/python baseball/rubber_04h_keypoint.py --train
...
right, pivot-foot centre). Skip with `s` when you cannot see both ends.
    ...
    .venv-cv/bin/python baseball/rubber_04i_train_pack.py
    .venv-cv/bin/python baseball/rubber_04c_label_server.py \
...
Usage:
    .venv-cv/bin/python baseball/rubber_04i_train_pack.py
    .venv-cv/bin/python baseball/rubber_04i_train_pack.py --limit 250
    .venv-cv/bin/python baseball/rubber_04i_train_pack.py --seasons 2025,2026
"""
...
def main() -> None:
    ...
    print("\ntag them:")
    print("  .venv-cv/bin/python baseball/rubber_04c_label_server.py \\")
    ...
    print("  .venv-cv/bin/python baseball/rubber_04h_keypoint.py --train")
