...
Usage:
    .venv-cv/bin/python baseball/rubber_04g_cv_measure.py --eval
    .venv-cv/bin/python baseball/rubber_04g_cv_measure.py --season 2025
    .venv-cv/bin/python baseball/rubber_04g_cv_measure.py --season 2026
    .venv-cv/bin/python baseball/rubber_04g_cv_measure.py --season 2025 --debug-dir data/rubber/debug_cv
"""
...
_SPEC = importlib.util.spec_from_file_location(
    "rubber_04_measure", REPO_ROOT / "baseball" / "rubber_04_measure.py"
)
