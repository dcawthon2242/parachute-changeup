...
Usage:
    .venv-cv/bin/python baseball/rubber_04j_pose_measure.py --build-dataset
    .venv-cv/bin/python baseball/rubber_04j_pose_measure.py --train
    .venv-cv/bin/python baseball/rubber_04j_pose_measure.py --eval
    .venv-cv/bin/python baseball/rubber_04j_pose_measure.py --measure 2025
"""
...
def make_pack(args: argparse.Namespace) -> None:
    ...
    print(f"\n  .venv-cv/bin/python baseball/rubber_04c_label_server.py --pack {out_dir}")
